...
const SectionPipeline = forwardRef<SlideHandle, SlideProps>((props, ref) => {
    ...
    return (
        <div className="w-full h-full flex flex-col justify-center items-center bg-background relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[1000px] bg-green-500/10 rounded-full blur-[150px] mix-blend-multiply" />
            </div>
            ...
            >
                ...
                >
                    <div className="p-6 rounded-2xl bg-green-500/10 border border-green-500/20">
                        <Waypoints className="w-20 h-20 text-green-500" />
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <p className="text-2xl text-muted max-w-2xl mx-auto leading-relaxed">
                        End-to-end processing workflow<br />from data acquisition to prediction
                    </p>
                </motion.div>
            </motion.div>
        </div>
...
SectionPipeline.displayName = "SectionPipeline";
