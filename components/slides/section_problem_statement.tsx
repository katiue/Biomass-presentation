...
const SectionProblemStatement = forwardRef<SlideHandle, SlideProps>((props, ref) => {
            ...
            >
                ...
                >
                    ...
                    <p className="text-2xl text-muted max-w-2xl mx-auto leading-relaxed">
                        Understanding carbon credits, biomass estimation,<br />and the limitations of current methods
                    </p>
                </motion.div>
            </motion.div>
        </div>
...
SectionProblemStatement.displayName = "SectionProblemStatement";
